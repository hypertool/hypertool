...
describe("User model", function () {
    ...
    it("should be created when countryCode is undefined", async () => {
        const newUser = new UserModel({
            ...user,
    ...
    it("should be created when countryCode is null", async () => {
        const newUser = new UserModel({
            ...user,
            countryCode: null,
        });
    ...
    it("should not be created when emailVerified is null", async () => {
        const newUser = new UserModel({
            ...user,
            emailVerified: null,
        });
        ...
        await assertThrowsAsync(
            async () => newUser.save(),
            "The emailVerified attribute is required.",
        );
    });
