 ...
 */
export class DefaultEventHandlers<O = any> extends CoreEventHandlers<
...
> {
    ...
    handlers() {
        ...
        return {
            connect: (el: HTMLElement, id: TNodeID) => {
            ...
            select: (el: HTMLElement, id: TNodeID) => {
                ...
                const unbindOnClick = this.addCraftEventListener(
                    ...
                    (e) => {
                        ...
                        const isNodeAlreadySelected =
                            this.currentSelectedElementIds.includes(
                                id as never,
                            );
            ...
            hover: (el: HTMLElement, id: TNodeID) => {
            ...
            drop: (el: HTMLElement, targetId: TNodeID) => {
            ...
            drag: (el: HTMLElement, id: TNodeID) => {
    ...
    private dropElement(
        ...
        const { draggedElementShadow } = this;
