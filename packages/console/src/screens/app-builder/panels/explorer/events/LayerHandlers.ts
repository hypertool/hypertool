                                ...
                                LayerHandlers.events.indicator = {
                                    ...
                                    placement: {
                                        currentNode: editorStore.query
                                            .node(currNode)
                                            .get(),
                                        index: currentCanvasHovered.data.nodes
                                            .length,
                                        where: "after",
                            ...
                            if (editorStore.query.node(parent.id).isCanvas()) {
                                if (parent.data.parent) {
                                    ...
                                    if (
                                        ...
                                        if (
                                            (e.clientY >
                                                parentHeadingInfo.bottom - 10 &&
                                                !this.getLayer(parent.id)
                                                    .expanded) ||
                                            e.clientY <
                                                parentHeadingInfo.top + 10
                                        ) {
                                            indicatorInfo.placement.parent =
                                                grandparent;
                                            indicatorInfo.placement.currentNode =
                                                parent;
                                            indicatorInfo.placement.index =
                                                grandparent.data.nodes
